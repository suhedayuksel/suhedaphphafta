            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    if( $sorgu_yazilar -> rowCount()){
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                               <a href="sample.php?id=<?php $satir_yazilar['id'];?>"> <img src="<?php echo substr($satir_yazilar['foto'],3);?>" alt="<?php echo $satir_yazilar['fotoalt'];?>" class="img-fluid"></a>
                            </div>
